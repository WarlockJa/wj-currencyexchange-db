...
// list of currencies based on the available free data from CurrencyApi
...
const useGetCurrencyOptions = (dictionary: TCurrenciesList) => {
  const [currencyOptions, setCurrencyOptions] = useState<JSX.Element[]>();
  // const { t, i18n } = useTranslation();
  // const dictionary: TCurrenciesList = await getDictionary(lang);
